...
{
    public class DetallePedidoInner
    {
        ...
        public virtual ICollection<DetallePedidoPersonalizadoInner> DetallePedidoPersonalizados { get; set; } = new List<DetallePedidoPersonalizadoInner>();
    }
}
